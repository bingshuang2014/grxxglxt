...
<c:forEach items="${list}" var="list" varStatus="st">
	<div id="rightDiv">
        <p><span style="display:inline-block;width:200px;text-align:right;">标题 </span>
        <input name="ntitle" type="text" class="opt_input" value="${list.title}"/></p>
    
        <p><span style="display:inline-block;width:200px;text-align:right;">时间</span>
        <input name="nauthor" type="text" class="opt_input" value="${list.addtime }"/></p>

        <p><span style="display:inline-block;width:200px;text-align:right;">地点</span>
        <input name="ntitle" type="text" class="opt_input" value="${list.place }"/></p>
    
        <p><span style="display:inline-block;width:200px;text-align:right;">事件</span>
        <input name="nauthor" type="text" class="opt_input" value="${list.thing }"/></p>
